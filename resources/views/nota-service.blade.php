...
if($data->cabang === 'Banjarbaru') {
    $no_service = "S.BJB.$data->no_service";
} elseif ($data->cabang === 'Landasan Ulin') {
    $no_service = "S.LNU.$data->no_service";
} elseif ($data->cabang === 'Banjarmasin') {
    $no_service = "S.BJM.$data->no_service";
}
        ...
        <div class="border mt-1" style="width: 100%;">
            ...
            <div class="float-left" style="width: 50%;">
                ...
                <div class="float-right" style="width: 79%;">
                    ...
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->penerimaan->merek . ' ' . $data->penerimaan->tipe }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->penerimaan->problem }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->penerimaan->permintaan }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->penerimaan->keterangan }}</p>
            ...
            <div class="float-right" style="width: 50%;">
                <div class="float-left" style="width: 25%;">
                    ...
                    <p class="lead ml-2 mt-0 mb-0" style="font-weight: bold; letter-spacing: 1.5px;">Barang Dibersihkan</p>
                ...
                <div class="float-right" style="width: 74%;">
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->penerimaan->kondisi }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: {{ $data->detailPengerjaan->waktu_selesai }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: {{ $status }}</p>
                    <p class="lead ml-2 mt-0 mb-0">: </p>
        ...
        <div class="border mt-1" style="width: 100%;">
            ...
            <div class="float-left mb-2" style="width: 33%;">
                ...
                <div class="float-right" style="width: 64%;">
                    <p class="lead ml-2 mt-0 mb-0">: Rp. {{ number_format($data->pengerjaan->biaya_service) }}</p>
                </div>                        
            </div>
            ...
            <div class="float-left mb-2" style="width: 33%;">
                ...
                <div class="float-right" style="width: 67%;">
                    <p class="lead ml-2 mt-0 mb-0">: Rp. {{ number_format($data->nominal) }}</p>
                </div>                        
            </div>
            ...
            <div class="float-left mb-2" style="width: 33%;">
                ...
                <div class="float-right" style="width: 74%;">
                    <p class="lead ml-2 mt-0 mb-0">: Rp. {{ number_format(intval($data->nominal) - intval($data->pengerjaan->biaya_service)) }}</p>
                </div>                        
            </div>
        </div>
